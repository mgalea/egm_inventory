        ...
        <div class="col-12">
          <table id="myTable" class="w3-table-all w3-hoverable w3-responsive">
            <tr>
              ...
              <?php } else { ?>
                <th class="w3-dark-grey w3-hover-black" onclick="w3.sortHTML('#myTable', '.item', 'td:nth-child(1)')" style="cursor:pointer">Inventory Number <i class="fa fa-sort" style="font-size:13px;"></i></th>
