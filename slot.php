...
<html>
  ...
  <body>
    ...
    <div class="div-body">
      ...
      if($connect && $serial_number != ""){
        ...
        $query= "SELECT * FROM slot_machines, manufacturer, type_slot_machines, slot_model WHERE fk_model = id_model AND fk_slot_type = id_type_slot_machines AND serial_number = \"".$serial_number."\";";
        ...
        if($result = $connect->query($query)){
          if($result->num_rows > 0){
            ...
            $query = "SELECT * FROM motherboard WHERE serial_number_motherboard = \"".$serial_number_motherboard."\";";
            if($result = $connect->query($query)){
              if($result->num_rows > 0){
                $row = $result->fetch_assoc();
                $com_jumper_number=$row["com_jumper_number"];
                $com_jumper_type=$row["com_jumper_type"];
                $power_jumper_number=$row["power_jumper_number"];
                $power_jumper_type=$row["power_jumper_type"];
                $model_motherboard=$row["model_motherboard"];
                $id_manufacturer_motherboard=$row["fk_manufacturer"];
              }
            }
      ...
      <div id="id_info_slot" class="modal-div-info">
        ...
        <div class="modal-div-content">
          <div class="container">
            <div class="col-50">
              <h2 style="margin-top: 20px; float : center;"><b>Info</b></h2>
              ...
              <label>Establishment: <?php if($establishment != "") echo $establishment; else echo  " - ";?></label></br>
              ...
              <label>Multi Game: <?php if($type_player == "1") echo "YES"; else echo "NO"; ?></label></br>
              <label>Multi-terminal: <?php if($multiterminal == "1") echo "YES"; else echo "NO"; ?></label></br>
              <label>State: <?php if($state == 1) echo "Commissioned"; else echo "Decommissioned"; ?></label></br>
            ...
            <div class="col-50">
              <h2 style="margin-top: 20px; float : center;"><b>Motherboard</b></h2>
              <label style="margin-top: 20px;">Is Original: <?php if($is_original == "1") echo "YES"; else echo "NO"; ?></label></br>
              <label>Serial Number Motherboard: <?php echo $serial_number_motherboard; ?></label></br>
              <?php
              ...
              <label>Model Motherboard: <?php echo $model_motherboard; ?></label></br>
              <div class="col-50">
                <fieldset>
              ...
              <div class="col-100-top">
                ...
                <label><?php if($est_location != "") echo $est_location; else echo "-";?></label>
              </div>
            </div>
          </div>
        </div>
      ...
      <div id="id_add_slot" class="modal-div">
        <span onclick="closeAdd()" class="close_add" title="Close">&times;</span>
        <form class="modal-div-content" action="PHP/<?php if(isset($_POST['slot'])) echo "editSlot.php"; else echo "addSlot.php"; ?>" method="POST">
          <div class="container">
            <h1><?php if(isset($_POST['slot'])) echo "Edit Slot"; else echo "New Slot"; ?></h1>
            <hr>
            ...
            ?>
              ...
              <input class="input-add" type="text" name="serial_number" value="<?php echo $serial_number; ?>" <?php if(isset($_POST['slot'])) echo "readonly"; else echo "required"; ?>>
      ...
      <div class="col-100">
        <table id="myTable" class="w3-table-all">
          <tr>
            ...
            <th class="w3-dark-grey w3-hover-black" onclick="w3.sortHTML('#myTable', '.item', 'td:nth-child(5)')" style="cursor:pointer">Brand <i class="fa fa-sort" style="font-size:13px;"></i></th>
            ...
            <th class="w3-dark-grey w3-hover-black" onclick="w3.sortHTML('#myTable', '.item', 'td:nth-child(4)')" style="cursor:pointer">Brand <i class="fa fa-sort" style="font-size:13px;"></i></th>
  ...
  <script type="text/javascript">
    ...
    $("#manufacturerSelect").change(function() {
      ...
      var value = $(this).val();
      if(value){
        $.post('PHP/selectSlotModel.php', { manufacturer: value}, function(data){
          if(data){
    ...
    $( "#operator_id" ).change(function() {
      ...
      if(operatorVal){
        ...
        $.post('PHP/selectEstablishment.php', { operator: operatorVal}, function(data){
          $('#establishment_id option').remove()
          if(data){
    ...
    $("#myTable tr").click(function(){
      ...
      var value=$(this).find('td:nth-child(<?php if(isset($_POST['operator']) || isset($_POST['establishment'])) echo "1"; else echo "2"; ?>)').html();
