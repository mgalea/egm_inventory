          ...
          <div class="col-99">
            <div class="col-50">
              <div>
                ...
                <label>Region</label>
                <input id="Region" class="input-add" type="text" name="RegionNm" value="<?php echo $region; ?>" >
                <label>City</label>
...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBu5JqnCRSQBplk02EP7sUdyBEGzXY8XoY&callback=initMap">
</script>
