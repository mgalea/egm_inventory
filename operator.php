          ...
          <div class="container">
            ...
            <div class="row">
              <div class="col-6">
                ...
                <tr>
                      <td>License Number:</td><td> <?php echo $official_license; ?></td>
                    </tr>
                    <tr>
                      <td>Name:</td><td> <?php echo $name; ?></td>
                    </tr>
                    <tr>
                      <td>Namber of Machines:</td><td> <?php echo $n_machines; ?></td>
                    </tr>
                    <tr>
                      <td>Namber of Active Machines:</td><td> <?php echo $n_a_machines; ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td>Web Site:</td><td> <?php echo $web; ?></td>
    </tr>
                    <tr>
                      <td>Jurisdiction: </td><td><?php echo $jurisdiction; ?></td>
                    </tr>
                    <tr>
                      <td>Brands:</td><td> <?php echo "</br>" . $brand_name; ?></td>
                    </tr>
                </table>
