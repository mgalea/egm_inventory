...
<html>
  ...
  <body>
    ...
    <div class="div-body">
      ...
      <div id="id_add_user" class="modal-div">
        ...
        <form id="formAdd" onsubmit="return onSubmitFunction()" class="modal-div-content" action="PHP/<?php if(isset($_POST['user'])) echo "editUser.php"; else echo "addUser.php"; ?>" method="POST">
          <div class="container">
            <h1><?php if(isset($_POST['user'])) echo "Edit User"; else echo "New User"; ?></h1>
            <hr>
          ...
          <div class="container">
            ...
            <div class="col-100-add">
              ...
              <div class="col-100-add input-add">
                ...
                <div class="col-58">
                  <button id = "addBrandOperator" type="button"/>
                </div>
              </div>
            </div>
            <div class="clearfix">
              <button type="button" onclick="closeModify()" class="cancelbtn button">Cancel</button>
              <button type="submit" class="button savebtn">Save</button>
            </div>
          </div>
        </form>
          ...
          <div class="container">
            ...
            <div class="col-100-add">
              ...
              <div class="col-100-add input-add">
                ...
                <div class="col-58">
                  <button id = "addTypeEstablishment" type="button"/>
                </div>
              </div>
            </div>
            <div class="clearfix">
          ...
          <div class="container">
            ...
            <div class="col-100-add">
              ...
              <div class="col-100-add input-add">
                ...
                <div class="col-58">
                  <button id = "addManufacturerSlot" type="button"/>
                </div>
              </div>
            </div>
            <div class="clearfix">
          ...
          <div class="container">
            ...
            <div class="col-100-add">
              ...
              <div class="col-100-add input-add">
                ...
                <div class="col-58">
                  <button id = "addTypeSlots" type="button"/>
                </div>
              </div>
            </div>
            <div class="clearfix">
      ...
      <div id="id_add_model_slots" class="modal-div-modify">
        ...
        <form id="formAddModelSlots" class="modal-div-content" action="PHP/add_model_slots.php" method="POST">
          <div class="container">
            <h1 id="slot_model_title">Slots Model</h1>
            <hr>
            <div class="tab">
              <table class="w3-table-all">
                <tr>
                  <th class="w3-dark-grey w3-hover-black" style="cursor:pointer">Manufacturer</th>
                </tr>
                <?php
                if($connect){
                  $query= "SELECT * from manufacturer;";
                  if($result = $connect->query($query)){
                    if($result->num_rows > 0){
                      while ($row = $result->fetch_assoc()) {
                        echo "<tr onclick=\"selectManufacturerModel(".$row["id_manufacturer"].",'".$row["name_manufacturer"]."')\" class=\"item\"><td>".$row["name_manufacturer"]."</td></tr>";
                      }
                    }
                  }
                }
            ...
            <div class="tab">
              <input id="manufacturerModelSlotsPHP" name="manufacturerModelSlotsPHP" type="text" style="display:none;">
              <input id="modelSlotsPHP" name="modelSlotPHP" type="text">
              <div class="col-100-add">
              ...
              <div class="clearfix">
                <button type="button" onclick="backSelectManufacturerModel()" class="cancelbtn button">Cancel</button>
                <button type="submit" class="button savebtn">Save</button>
              </div>
            </div>
          </div>
      ...
      <div class="col-100">
        <div class="col-25-border-right">
          <button class="button" onclick="document.getElementById('id_add_brand_operator').style.display='block'">Add Operators Brand</button>
        </div>
        <div class="col-25-border">
          <button class="button" onclick="document.getElementById('id_add_type_establishment').style.display='block'">Add Establishment Type</button>
        </div>
      </div>
      <div class="col-100">
        <div class="col-25-border-right">
          <button class="button" onclick="document.getElementById('id_add_manufacturer_slots').style.display='block'">Add Slots Manufacturer</button>
        </div>
        <div class="col-25-border">
          <button class="button" onclick="document.getElementById('id_add_model_slots').style.display='block'">Add Slots Model</button>
        </div>
        <div class="col-25-border">
          <button class="button" onclick="document.getElementById('id_add_manual_slots').style.display='block'">Add Slots Manual</button>
        </div>
        <div class="col-25-border-left">
          <button class="button" onclick="document.getElementById('id_add_type_slots').style.display='block'">Add Slots Type</button>
        </div>
      </div>
      <div class="col-100">
        <h1>Users</h1>
      ...
      <div class="col-100">
        <div class="col-75">
          <input type="text" id="myInput" onkeyup="searchInUsers()" placeholder="Search ...">
        </div>
        <div class="col-25">
          <button class="button" onclick="document.getElementById('id_add_user').style.display='block'">Add User</button>
        </div>
      </div>
      <div class="col-100">
  ...
  <script type="text/javascript">
    ...
    function updateModelSlot(){
      ...
      arrayModelSlot_del = "";
      document.getElementById("modelSlotsPHP").value = array;
    }
